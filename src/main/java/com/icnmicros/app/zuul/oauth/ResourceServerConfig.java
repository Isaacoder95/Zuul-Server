package com.icnmicros.app.zuul.oauth;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/api/security/oauth/**").permitAll()
				...
				.hasAnyRole("ROLE_ADMIN", "USER").antMatchers("/api/productos/**", "/api/items/**", "/api/usuarios/**")
		 ...
		 * .hasRole("ADMIN").antMatchers(HttpMethod.DELETE,
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		// Options para los endpoints oatu2
	...
	public JwtAccessTokenConverter accessTokenConverter() {
		...
		tokenConverter.setSigningKey(jwtFirma);
